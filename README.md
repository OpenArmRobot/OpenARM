...
With high backdrivability and compliance with High cost-effective standard for robot joint motors in China's supply chain, it excels at safe human-robot.
  ...
  Model: 
    OpenARM_01_DM :  OpenARM 01 with Damiao Motors  -  (供应链：达妙科技   未认证            供货状态稳定不稳定）
	        -----    CAD    结构设计文件 for  OpenARM_01_DM   Compatiable with OpenArm.dev 's  OpenArm01 
	        -----   Driver  硬件驱动       for  OpenARM_01_DM 
	        -----   PCB    PCBA主板设计  for  OpenARM_01_DM 
	        -----   Wiring  接线设计和教程  for  OpenARM_01_DM 
    OpenARM_01_RS   :  OpenARM 01 with Robstride Motors (供应链：灵足电机   已验证小米系供应链  ，供货状态稳定)
	        -----    CAD    结构设计文件  for OpenARM_01_RS
	        -----   Driver  硬件驱动         for OpenARM_01_RS
	        -----   PCB    PCBA主板设计   for OpenARM_01_RS
	        -----   Wiring  接线设计和教程   for OpenARM_01_RS
    OpenARM_01_HC   :  OpenARM 01 with HCFA Motors   (供应链：禾川电机 上市公司  禾川科技股票代码  688320.sh ，供货状态稳定) 
	        -----    CAD    结构设计文件   for OpenARM_01_HC
	        -----   Driver  硬件驱动  for OpenARM_01_HC
	        -----   PCB    PCBA主板设计   for OpenARM_01_HC
	        -----   Wiring  接线设计和教程   for OpenARM_01_HC
