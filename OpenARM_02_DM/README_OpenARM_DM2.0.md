OpenARM is an open-source remake version 7DOF humanoid arm hardware designed for physical AI research and deployment in many environments.
 ...
 ##Hardware Model: 
	OpenARM_02_DM:  OpenARM 02 with Damiao Motors   
	         Compatiable with OpenArm.dev 's  OpenArm 2.0
	      CAD :本体硬件工程构设计文件 for  OpenARM_02_DM 
 		...
 		提供兼容国际版仿真构型完整一致的的机械加工 3D 模型，用于 3D 打印或 CNC 制造
	        -----   Driver  硬件驱动       for  OpenARM_02_DM 
	        -----   PCB    PCBA主板设计  for  OpenARM_02_DM 
	        -----   Wiring  接线设计和教程  for  OpenARM_02_DM 
 SubDirectory:
	 Driver/:
  		 CAN_BUS 电机驱动
	   EtherCat   总线驱动
